...
class OwnerViewSet(viewsets.ViewSet):
            ...
            def login_sub_owner(self, request):
                try:
                    ...
                    print('SSSSSS userType ', user.userType)
                    print('SSSSSS name ', user.name)
                    ...
                    if user.userType != UserModel.SUB_OWNER:
                        return response_fun(RESPONSE_INVALID, {'message': 'Permission issue. Only for sub owner login', 'code': ERROR_CODE_UNAUTHORIZED})
            ...
            def address_delete(self, request, pk=None):
